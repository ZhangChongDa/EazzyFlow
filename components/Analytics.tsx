...
const CAMPAIGNS_LIST = [
  { 
    ...
    sent: 150000, cvr: 4.2, revenue: 42500, roi: '1:8.5', 
  ...
  { 
    ...
    sent: 45000, cvr: 1.1, revenue: 5200, roi: '1:1.2', 
  ...
  { 
    ...
    sent: 1200, cvr: 18.5, revenue: 18000, roi: '1:12', 
         ...
         <div className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
            <table className="w-full text-sm text-left">
               ...
               <tbody className="divide-y divide-slate-100">
                  {CAMPAIGNS_LIST.filter(c => statusFilter === 'All' || c.status === statusFilter).map(campaign => (
